...
/**
 * <a href="https://leetcode-cn.com/problems/make-the-xor-of-all-segments-equal-to-zero/">使所有区间的异或结果为零</a>
 *
...
public class MakeTheXorOfAllSegmentsEqualToZero {
    ...
    @Complexity(value = Complexity.ComplexityType.O_DEFINE, complexity = "O(2^C*k+n)")
